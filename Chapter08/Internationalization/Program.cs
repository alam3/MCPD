...
namespace Internationalization {
    class Program {
        static void Main(string[] args) {
            // Using the CultureInfo type in System.Globalization for internationalization

            // Current globalization/localization culture
            ...
            // Prompt user for a new culture code to show examples
