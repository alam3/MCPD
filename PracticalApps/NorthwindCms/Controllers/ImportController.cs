// Define a controller to import categories and products from Northwind DB into instances of the new custom content types.
    ...
    public class ImportController : Controller {
        ...
        public async Task<IActionResult> Import() {
            ...
            foreach (Category c in db.Categories.Include(c => c.Products)) {
                // if the category page already exists then skip to the next iteration of the loop
                ...
                if (cp == null) {
                    ...
                    if (cp.Products.Count == 0) {
                        // convert the products for this category into a list of instances of ProductRegion
                        cp.Products = c.Products.Select(p => new ProductRegion {
                            ...
                            UnitsInStock = p.UnitsInStock ?? 0 // if not null return p.UnitsInStock, else 0
                        }).ToList();
                    }
